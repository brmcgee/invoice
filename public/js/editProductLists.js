...
function htmlProducts(i){
    ...
    prod.forEach(p => {
      ...
      html += `
          <tr id="row${p.prodId}">
            <th scope="row">
              <span class="prodId small" id="prodId${p.prodId}">${p.prodId}</span>
              <button onclick="editProductRow(${p.prodId})" class="btn btn-light border-0 btn-sm p-0">
                <img src="public/assets/icons/pencil-black.png" width="23">
              </button>
            </th>
            ...
            <td>            
              <button class="btn border-0 btn-sm btn-light p-0" onclick="removeLineItem(${p.prodId})">
                <img src="public/assets/icons/delete-black.png" width="23">
              </button>
            </td>
          </tr>
    ...
    html += `
      ...
      <h4>
        <span id="modalCost" class="float-end">$${invs[i].cost}.00</span>
      </h4>
    `
...
function editProductRow(id){
  ...
  let html = `
            ...
            <td class="item" id="pItem${id}" contenteditable="true" onkeyup="getInvoiceCost()"> ${item.innerHTML} </td>
